...
//!
//! ### Checking memory use
//! Use [`MemoryUse::capture`] to get the current memory use of your
//! application.
//!
...
//! ```
//!
//! Now let your app run for a while, and then call
//! [`accounting_allocator::tracking_stats`] to get the statistics. Any memory
//! leak should show up in [`TrackingStatistics::top_callstacks`].
//!
//! ### More
...
pub use {
    ...
    allocation_tracker::CallstackStatistics,
    // memory_history::MemoryHistory,
    // memory_limit::MemoryLimit,
    memory_use::MemoryUse,
    // ram_warner::*,
    readable_backtrace::ReadableBacktrace,
};
...
impl BacktraceHash {
    pub fn new(backtrace: &Backtrace) -> Self {
        ...
        let mut hasher = std::hash::BuildHasher::build_hasher(&ahash::RandomState::with_seeds(0, 1, 2, 3));
