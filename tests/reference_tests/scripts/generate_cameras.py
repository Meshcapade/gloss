...
if __name__ == "__main__":
    lookat = np.array(
        [0, 0.9, 0]
    )  # This looks at roughly the center of the mesh (to avoid empty renders)
    radius_range = (
        1.0,
        2.0,
    )  # Range of radii for cameras, the farthest point of the mesh has a radius of 0.48
    height_range = (
        0.5,
        2.0,
    )  # Range of heights for cameras, the range for the mesh is 0 -> 1.66
