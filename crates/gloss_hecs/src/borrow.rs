...
///  - `0b1_______...` the counter is mut borrowed, and some other thread is
///    trying to borrow
#[repr(C)]
...
impl AtomicBorrow {
    ...
    pub fn borrow(&self) -> bool {
        ...
        // }
        assert!(prev_value & COUNTER_MASK != COUNTER_MASK, "immutable borrow counter overflowed");
    ...
    pub fn borrow_mut(&self) -> bool {
        self.0.compare_exchange(0, UNIQUE_BIT, Ordering::Acquire, Ordering::Relaxed).is_ok()
    }
