...
def test_depth():
    ...
    with Progress() as progress:
        ...
        for camera in cameras:
            ...
            gloss_depth_np_remapped = \
                np.squeeze(gloss_depth.depth_linearize(device, queue, znear, zfar))
            ...
            path_to_reference_silhouette = \
                osp.join(root_path, "../silhouette_test", "references", str(camera_id) + ".png")
            ...
            image_difference = \
                gloss_depth_np_remapped[silhouette_mask] - reference_depth[silhouette_mask]
