...
impl TryInto<image::ExtendedColorType> for ExtendedColorType {
    type Error = String;
    fn try_into(self) -> Result<image::ExtendedColorType, Self::Error> {
        match self {
            ExtendedColorType::A8 => Ok(image::ExtendedColorType::A8),
            ExtendedColorType::L1 => Ok(image::ExtendedColorType::L1),
            ExtendedColorType::La1 => Ok(image::ExtendedColorType::La1),
            ExtendedColorType::Rgb1 => Ok(image::ExtendedColorType::Rgb1),
            ExtendedColorType::Rgba1 => Ok(image::ExtendedColorType::Rgba1),
            ExtendedColorType::L2 => Ok(image::ExtendedColorType::L2),
            ExtendedColorType::La2 => Ok(image::ExtendedColorType::La2),
            ExtendedColorType::Rgb2 => Ok(image::ExtendedColorType::Rgb2),
            ExtendedColorType::Rgba2 => Ok(image::ExtendedColorType::Rgba2),
            ExtendedColorType::L4 => Ok(image::ExtendedColorType::L4),
            ExtendedColorType::La4 => Ok(image::ExtendedColorType::La4),
            ExtendedColorType::Rgb4 => Ok(image::ExtendedColorType::Rgb4),
            ExtendedColorType::Rgba4 => Ok(image::ExtendedColorType::Rgba4),
            ExtendedColorType::L8 => Ok(image::ExtendedColorType::L8),
            ExtendedColorType::La8 => Ok(image::ExtendedColorType::La8),
            ExtendedColorType::Rgb8 => Ok(image::ExtendedColorType::Rgb8),
            ExtendedColorType::Rgba8 => Ok(image::ExtendedColorType::Rgba8),
            ExtendedColorType::L16 => Ok(image::ExtendedColorType::L16),
            ExtendedColorType::La16 => Ok(image::ExtendedColorType::La16),
            ExtendedColorType::L32F => Err("Cannot convert color type".to_string()),
            ExtendedColorType::Rgb16 => Ok(image::ExtendedColorType::Rgb16),
            ExtendedColorType::Rgba16 => Ok(image::ExtendedColorType::Rgba16),
            ExtendedColorType::Bgr8 => Ok(image::ExtendedColorType::Bgr8),
            ExtendedColorType::Bgra8 => Ok(image::ExtendedColorType::Bgra8),
            ExtendedColorType::Rgb32F => Ok(image::ExtendedColorType::Rgb32F),
            ExtendedColorType::Rgba32F => Ok(image::ExtendedColorType::Rgba32F),
            ExtendedColorType::Cmyk8 => Ok(image::ExtendedColorType::Cmyk8),
            ExtendedColorType::Unknown(v) => Ok(image::ExtendedColorType::Unknown(v)),
        }
    }
}
...
impl<T: $($bound+)*> Pixel for $ident<T> {
    ...
    fn from_slice(slice: &[T]) -> &$ident<T> {
        ...
        unsafe { &*slice.as_ptr().cast::<$ident<T>>() }
    }
    fn from_slice_mut(slice: &mut [T]) -> &mut $ident<T> {
        assert_eq!(slice.len(), $channels);
        unsafe { &mut *slice.as_mut_ptr().cast::<$ident<T>>() }
    }
